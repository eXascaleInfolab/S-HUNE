...
- Evaluation on the node classification task (calssification evaluation using Deepwalk testing code: you need python with gensim, sklearn and scipy installed)
